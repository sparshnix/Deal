...
//		SelectCustomerDropdown.sendKeys(Masterdata.NewCustomer);
		...
		WebElement ServiceJobStatus = driver.findElement(By.xpath(servicejobstatus));
		Assert.assertTrue(ServiceJobStatus.isDisplayed(), "ServiceJobStatus is missing");
		log.info("ServiceJobStatus is visible");
		log.info("ServiceJobStatus is " +ServiceJobStatus.getText());
		Assert.assertEquals(ServiceJobStatus.getText(), "Status: New");
...
//		ServiceJobDropdown.click();
		...
		driver.findElement(By.xpath(addcustomerunit)).click();
		Thread.sleep(10000);
		...
		WebElement Searchbox = driver.findElement(By.id("autocompleteServiceJob0"));
		Assert.assertTrue(Searchbox.isDisplayed(), "Searchbox is missing");
		log.info("Searchbox is visible");
...
//		Searchbox.sendKeys(Masterdata.NewLabor);
		Searchbox.sendKeys("Qalabor-14_12_202112_21_06");
		Thread.sleep(10000);
...
//		Searchbox.sendKeys(POM.NewSublet);
		...
		WebElement VerifyTechnician = driver.findElement(By.id("assignedTech.Id"));
